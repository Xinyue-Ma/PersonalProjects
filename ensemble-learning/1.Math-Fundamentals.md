...
| Distribution | Distribution Function PDF | E(X) | Var(X) |
| :---: | :---: | :---: | :---: |
| [Normal Distribution](https://zh.wikipedia.org/wiki/%E6%AD%A3%E6%80%81%E5%88%86%E5%B8%83) | f(x;mu,sigma)={\frac {1}{\sigma {\sqrt {2\pi }}}}\;e^{-{\frac {\left(x-\mu \right)^{2}}{2\sigma ^{2}}}}\} | mu | sigma^2 |
