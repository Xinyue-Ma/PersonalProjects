...
- [Bernoulli Distribution](https://zh.wikipedia.org/wiki/%E4%BC%AF%E5%8A%AA%E5%88%A9%E5%88%86%E5%B8%83)

Probability mass function: f(X)=p^x*(1-p)^(1-x) | E(X)=p    | Var(X)=p(q-p)
