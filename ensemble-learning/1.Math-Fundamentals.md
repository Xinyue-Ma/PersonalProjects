...
| Distribution | Distribution Function | E(X) | Var(X) |
| :---: | :---: | :---: | :---: |
| [Bernoulli Distribution](https://zh.wikipedia.org/wiki/%E4%BC%AF%E5%8A%AA%E5%88%A9%E5%88%86%E5%B8%83) | PMF: f(X;p)=p^x*(1-p)^(1-x) | p | p(1-p) |
| [Binomial distribution](https://zh.wikipedia.org/wiki/%E4%BA%8C%E9%A0%85%E5%BC%8F%E5%88%86%E5%B8%83) | CDF: F(X;n,p)=\sum _{i=0}^{x}{n \choose i}p^{i}(1-p)^{n-i}} | np | np(1-p) |
| [Geometric distribution](https://zh.wikipedia.org/wiki/%E5%B9%BE%E4%BD%95%E5%88%86%E4%BD%88) | PDF: f(x;p) = (1 − p)^(x − 1)*p | 1/p | (1-p)/(p^2) |
| [Poisson Distribution](https://zh.wikipedia.org/wiki/%E5%8D%9C%E7%93%A6%E6%9D%BE%E5%88%86%E5%B8%83) | PMF： P(X=k;lamfa)=\frac{e^{-\lambda}\lambda^k}{k!} | lamda | lamda |
